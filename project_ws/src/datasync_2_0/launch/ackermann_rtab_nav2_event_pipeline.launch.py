...
def generate_launch_description():
    ...
    default_nav2 = os.path.join(limo_bringup_share, "param", "nav2_ackermann_rtab.yaml")

    ackermann_state = os.path.join(limo_car_share, "launch", "ackermann.launch.py")
    ackermann_nav2 = os.path.join(
        limo_bringup_share, "launch", "humble", "limo_rtab_nav2_ackermann.launch.py"
    )
    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                "use_sim_time",
                default_value="true",
                description="Use simulated time (recommended for rosbag + Nav2)",
            ),
            DeclareLaunchArgument(
                "use_bag",
                default_value="true",
            ...
            DeclareLaunchArgument(
                ...
                description="Nav2 ackermann RTAB params file",
            ),
            DeclareLaunchArgument(
                "nav2_map",
